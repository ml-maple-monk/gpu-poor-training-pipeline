    ...
    while True:
        ...
        try:
            ...
            tags = {
                ...
                "precision": str(getattr(runtime_args, "precision", "")),
                "architecture_variant": str(getattr(runtime_args, "architecture_variant", "")),
                "compile_fullgraph": str(bool(getattr(runtime_args, "compile_fullgraph", False))),
